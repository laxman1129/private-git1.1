...
PERSIST_DIRECTORY = os.getenv("PERSIST_DIRECTORY") # get the directory to store the vectors

# define the Chroma settings
CHROMA_SETTINGS = Settings(
    chroma_api_impl='duckdb+parquet', # use the DuckDB implementation with Parquet files
